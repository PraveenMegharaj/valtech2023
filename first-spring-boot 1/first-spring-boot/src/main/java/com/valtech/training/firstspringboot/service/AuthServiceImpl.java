...
public class AuthServiceImpl implements AuthService,UserDetailsService {
    ...
    public void populateUsers() {
		...
		com.valtech.training.firstspringboot.entity.User user=  createUser(model);
		//com.valtech.training.firstspringboot.entity.User user=createUser(model);
		//upgradeUserToAdmin(user.getId());
	}
    
    @Override
	public com.valtech.training.firstspringboot.entity.User createUser(RegisterUserModel registerUserModel) {
		String pass=passwordEncoder.encode(registerUserModel.getPassword());
    	com.valtech.training.firstspringboot.entity.User user=new com.valtech.training.firstspringboot.entity.User(registerUserModel.getUsername(),pass,Arrays.asList("ROLE_USER","ROLE_ADMIN"));
	...
	public boolean changePassword(ChangePasswordModel changePasswordModel) {
    	com.valtech.training.firstspringboot.entity.User user=userRepo.findByUsername(changePasswordModel.getUsername());
	...
	public void upgradeUserToAdmin(long id) {
    	com.valtech.training.firstspringboot.entity.User user =userRepo.getReferenceById(id);
    	user.addRole("ADMIN");
    	userRepo.save(user);
    }
